  ...
  return (
    <div className="rq-status-card">
      ...
      {query.status === 'escalated' && (
         <div className="rq-escalated-notice" style={{ marginTop: 'var(--space-md)', padding: 'var(--space-md)', backgroundColor: 'rgba(239, 68, 68, 0.1)', borderRadius: 'var(--radius-md)', borderLeft: '4px solid #ef4444' }}>
